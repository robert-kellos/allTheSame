...
{
    /// <summary>
    ///     CommunityWorkerController to expose REST service endpoints for CommunityWorker data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/CommunityWorker")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class CommunityWorkerController : BaseApiController<CommunityWorker>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof (IEnumerable<CommunityWorker>))]
        [HttpGet]
        public override IEnumerable<CommunityWorker> Get()
        {
            return base.Get();
        }

        // GET: api/CommunityWorker/5
        /// <summary>
        ...
        /// </returns>
        [ResponseType(typeof (CommunityWorker))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] CommunityWorker item)
        {
            return base.Put(id, item);
        }

        // POST: api/CommunityWorker
        /// <summary>
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] CommunityWorker item)
        {
            return base.Post(item);
        }

        // DELETE: api/CommunityWorker/5
        /// <summary>
