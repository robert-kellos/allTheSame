...
{
    /// <summary>
    ///     CommunityWorker_AlertController to expose REST service endpoints for CommunityWorker_Alert data.
    /// </summary>
    /// <note>
    ...
    public class CommunityWorker_AlertController : BaseApiController<CommunityWorker_Alert>
    {
        ...
        // GET: api/CommunityWorker_Alert/5
        /// <summary>
        ...
        // PUT: api/CommunityWorker_Alert/5
        /// <summary>
        ...
        // POST: api/CommunityWorker_Alert
        /// <summary>
        ...
        // DELETE: api/CommunityWorker_Alert/5
        /// <summary>
