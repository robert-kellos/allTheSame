...
{
    /// <summary>
    ///     AlertTypeController to expose REST service endpoints for AlertType data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/AlertType")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class AlertTypeController : BaseApiController<AlertType>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof(IEnumerable<AlertType>))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] AlertType item)
        {
        ...
        [ResponseType(typeof(IHttpActionResult))]
        [HttpPost]
        public override IHttpActionResult Post([FromBody] AlertType item)
        {
            return base.Post(item);
        }

        // DELETE: api/AlertType/5
        /// <summary>
