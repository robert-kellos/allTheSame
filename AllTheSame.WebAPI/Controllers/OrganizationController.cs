...
{
    /// <summary>
    ///     OrganizationController to expose REST service endpoints for Organization data.
    /// </summary>
    /// <note>
    ...
    public class OrganizationController : BaseApiController<Organization>
    {
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Organization item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Organization item)
        {
