...
{
    /// <summary>
    ///     CommunityAdminController to expose REST service endpoints for CommunityAdmin data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/CommunityAdmin")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class CommunityAdminController : BaseApiController<CommunityAdmin>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof(IEnumerable<CommunityAdmin>))]
        [HttpGet]
        public override IEnumerable<CommunityAdmin> Get()
        {
            return base.Get();
        }

        // GET: api/CommunityAdmin/5
        /// <summary>
        ...
        /// </returns>
        [ResponseType(typeof(CommunityAdmin))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] CommunityAdmin item)
        {
            return base.Put(id, item);
        }

        // POST: api/CommunityAdmin
        /// <summary>
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] CommunityAdmin item)
        {
            return base.Post(item);
        }

        // DELETE: api/CommunityAdmin/5
        /// <summary>
