...
{
    /// <summary>
    ///     VisitController to expose REST service endpoints for Visit data.
    /// </summary>
    /// <note>
    ...
    public class VisitController : BaseApiController<Visit>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof (IEnumerable<Visit>))]
        [HttpGet]
        public override IEnumerable<Visit> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Visit item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Visit item)
        {
