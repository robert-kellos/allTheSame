...
{
    /// <summary>
    ///     OrgTypeController to expose REST service endpoints for OrgType data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/OrgType")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class OrgTypeController : BaseApiController<OrgType>
    {
        #region Common CRUD
