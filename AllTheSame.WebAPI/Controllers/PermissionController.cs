...
{
    /// <summary>
    ///     PermissionController to expose REST service endpoints for Permission data.
    /// </summary>
    /// <note>
    ...
    public class PermissionController : BaseApiController<Permission>
    {
        ...
        [HttpGet]
        public override IEnumerable<Permission> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Permission item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Permission item)
        {
