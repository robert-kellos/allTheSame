...
{
    /// <summary>
    ///     VendorTypeController to expose REST service endpoints for VendorType data.
    /// </summary>
    /// <note>
    ...
    public class VendorTypeController : BaseApiController<VendorType>
    {
        #region Common CRUD
        ...
        [HttpGet]
        public override IEnumerable<VendorType> Get()
        {
            return base.Get();
        }
        ...
        /// </returns>
        [ResponseType(typeof(VendorType))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] VendorType item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] VendorType item)
        {
