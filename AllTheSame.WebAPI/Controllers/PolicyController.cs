...
{
    /// <summary>
    ///     PolicyController to expose REST service endpoints for Policy data.
    /// </summary>
    /// <note>
    ...
    public class PolicyController : BaseApiController<Policy>
    {
        #region Common CRUD
        ...
        [HttpGet]
        public override IEnumerable<Policy> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Policy item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Policy item)
        {
