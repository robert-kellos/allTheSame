...
{
    /// <summary>
    ///     CommunityController to expose REST service endpoints for Community data.
    /// </summary>
    /// <note>
    ...
    public class CommunityController : BaseApiController<Community>
    {
        #region Common CRUD
        ...
        [HttpGet]
        public override IEnumerable<Community> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Community item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Community item)
        {
