...
{
    /// <summary>
    ///     ModuleController to expose REST service endpoints for Module data.
    /// </summary>
    /// <note>
    ...
    public class ModuleController : BaseApiController<Module>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof(IEnumerable<Module>))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Module item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Module item)
        {
