...
{
    /// <summary>
    ///     IndustryController to expose REST service endpoints for Industry data.
    /// </summary>
    /// <note>
    ...
    public class IndustryController : BaseApiController<Industry>
    {
        #region Common CRUD
        ...
        [HttpGet]
        public override IEnumerable<Industry> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Industry item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Industry item)
        {
