...
{
    /// <summary>
    ///     UserController to expose REST service endpoints for User data.
    /// </summary>
    /// <note>
    ...
    public class UserController : BaseApiController<User>
    {
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] User item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] User item)
        {
