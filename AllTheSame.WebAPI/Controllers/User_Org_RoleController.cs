...
{
    /// <summary>
    ///     User_Org_RoleController to expose REST service endpoints for User_Org_Role data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/User_Org_Role")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class User_Org_RoleController : BaseApiController<User_Org_Role>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof(IEnumerable<User_Org_Role>))]
        [HttpGet]
        public override IEnumerable<User_Org_Role> Get()
        {
            return base.Get();
        }

        // GET: api/User_Org_Role/5
        /// <summary>
        ...
        /// </returns>
        [ResponseType(typeof(User_Org_Role))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] User_Org_Role item)
        {
            return base.Put(id, item);
        }

        // POST: api/User_Org_Role
        /// <summary>
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] User_Org_Role item)
        {
            return base.Post(item);
        }

        // DELETE: api/User_Org_Role/5
        /// <summary>
