...
{
    /// <summary>
    ///     VendorController to expose REST service endpoints for Vendor data.
    /// </summary>
    /// <note>
    ...
    public class VendorController : BaseApiController<Vendor>
    {
        #region Common CRUD
        ...
        [HttpGet]
        public override IEnumerable<Vendor> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Vendor item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Vendor item)
        {
