...
{
    /// <summary>
    ///     VisitorController to expose REST service endpoints for Visitor data.
    /// </summary>
    /// <note>
    ...
    public class VisitorController : BaseApiController<Visitor>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof (IEnumerable<Visitor>))]
        [HttpGet]
        public override IEnumerable<Visitor> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Visitor item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Visitor item)
        {
