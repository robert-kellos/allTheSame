...
{
    /// <summary>
    ///     RoleController to expose REST service endpoints for Role data.
    /// </summary>
    /// <note>
    ...
    public class RoleController : BaseApiController<Role>
    {
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Role item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Role item)
        {
