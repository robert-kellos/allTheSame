...
{
    /// <summary>
    ///     KioskController to expose REST service endpoints for Kiosk data.
    /// </summary>
    /// <note>
    ...
    public class KioskController : BaseApiController<Kiosk>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof (IEnumerable<Kiosk>))]
        [HttpGet]
        public override IEnumerable<Kiosk> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] Kiosk item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] Kiosk item)
        {
