...
{
    /// <summary>
    ///     KioskStatusController to expose REST service endpoints for KioskStatus data.
    /// </summary>
    /// <note>
    ...
    /// </note>
    [RoutePrefix("api/KioskStatus")]
    //[Authorize(Roles = AppConstants.PermissionCode.ViewVendor)]
    public class KioskStatusController : BaseApiController<KioskStatus>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof (IEnumerable<KioskStatus>))]
        [HttpGet]
        public override IEnumerable<KioskStatus> Get()
        {
            return base.Get();
        }

        // GET: api/KioskStatus/5
        /// <summary>
        ...
        /// </returns>
        [ResponseType(typeof (KioskStatus))]
        [HttpGet]
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] KioskStatus item)
        {
            return base.Put(id, item);
        }

        // POST: api/KioskStatus
        /// <summary>
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] KioskStatus item)
        {
            return base.Post(item);
        }

        // DELETE: api/KioskStatus/5
        /// <summary>
