...
{
    /// <summary>
    ///     FamilyMemberController to expose REST service endpoints for FamilyMember data.
    /// </summary>
    /// <note>
    ...
    public class FamilyMemberController : BaseApiController<FamilyMember>
    {
        #region Common CRUD
        ...
        /// </returns>
        [ResponseType(typeof(IEnumerable<FamilyMember>))]
        [HttpGet]
        public override IEnumerable<FamilyMember> Get()
        {
            return base.Get();
        }
        ...
        [HttpPut]
        public override IHttpActionResult Put(long? id, [FromBody] FamilyMember item)
        {
        ...
        [HttpPost]
        public override IHttpActionResult Post([FromBody] FamilyMember item)
        {
