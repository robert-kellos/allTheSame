...
{
    /// <summary>
    ///     ApplyAllTheSameSchemaMods
    /// </summary>
    public class ApplyAllTheSameSchemaMods : ISchemaFilter
    {
        /// <summary>
        ...
        public void Apply(Schema schema, SchemaRegistry schemaRegistry, Type type)
        {
            ...
            {
                //- Seems Swashbuckle can't decide if it wants to use ProperCase or camelCase
                ...
                {
                    var camel = propName.ToCamelCase();
                    if (schema.properties.ContainsKey(camel))
                    {
    ...
    public class SwaggerConfig
    {
        ...
        public static void Register()
        {
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "AllTheSame.WebAPI");
                    ...
                    c.SchemaFilter<ApplyAllTheSameSchemaMods>();
        ...
        {
            var xmlDoc = string.Format(@"{0}bin\AllTheSame.WebAPI.XML", AppDomain.CurrentDomain.BaseDirectory);
            return xmlDoc;
        }
    }
}