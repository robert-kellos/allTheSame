...
{
    public class CommunityImportMap : EntityTypeConfiguration<CommunityImport>
    {
        public CommunityImportMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.CommunityType)
                .HasMaxLength(50);
            ...
            this.Property(t => t.CommunityType).HasColumnName("CommunityType");
