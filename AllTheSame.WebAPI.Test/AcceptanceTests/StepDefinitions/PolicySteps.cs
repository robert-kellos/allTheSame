...
{
    [Binding]
    public class PolicySteps : BaseServiceTest//AuthenticatedTest //- Allows automatic fetching of token for each get call
    {
        ...
        private string _documentUrl = "www.google.com";
        //
