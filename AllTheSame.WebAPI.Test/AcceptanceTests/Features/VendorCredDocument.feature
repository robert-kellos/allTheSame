...
@VendorCredDocument 
#[C]RUD - [Post] :: Create, Check, GetById, Update and Delete VendorCredDocument, by passing a newly populated VendorCredDocument
Scenario: VendorCredDocument--Add, Check, GetById, Update and Delete VendorCredDocument
	Given the following VendorCredDocument Add input
		| Title    | URL            | Text     |
		| SpecFlow | www.google.com | SpecTest |
...
Scenario: VendorCredDocument--Retrieve all VendorCredDocuments
...
Scenario: Add a VendorCredDocument
	Given the following VendorCredDocument Add input
		| Title			| URL            | Text     |
		| SpecFlowTest	| www.google.com | SpecTest | 
