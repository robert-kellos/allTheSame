...
@Role 
#[C]RUD - [Post] :: Create, Check, GetById, Update and Delete Role, by passing a newly populated Role
Scenario: Role--Add, Check, GetById, Update and Delete Role
	Given the following Role Add input
		| Name		  | 
		| SpecFlow    | 
	When I call the add Role Post api endpoint to add a Role it checks if exists pulls item edits it and deletes it
...
Scenario: Role--Retrieve all Roles
