...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class VendorWorkerService : SyncEntityService<VendorWorker, IVendorWorkerRepository>, IVendorWorkerService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public VendorWorkerService(IUnitOfWork unitOfWork, IVendorWorkerRepository repository)
