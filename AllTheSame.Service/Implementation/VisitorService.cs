...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class VisitorService : EntityService<Visitor, IVisitorRepository>, IVisitorService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public VisitorService(IUnitOfWork unitOfWork, IVisitorRepository repository)
