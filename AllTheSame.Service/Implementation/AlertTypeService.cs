...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class AlertTypeService : EntityService<AlertType, IAlertTypeRepository>, IAlertTypeService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public AlertTypeService(IUnitOfWork unitOfWork, IAlertTypeRepository repository)
