...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class RequirementService : EntityService<Requirement, IRequirementRepository>, IRequirementService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public RequirementService(IUnitOfWork unitOfWork, IRequirementRepository repository)
