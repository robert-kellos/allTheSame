...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class ResidentService : SyncEntityService<Resident, IResidentRepository>, IResidentService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public ResidentService(IUnitOfWork unitOfWork, IResidentRepository repository)
