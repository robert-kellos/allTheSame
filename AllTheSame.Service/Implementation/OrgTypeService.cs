...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class OrgTypeService : EntityService<OrgType, IOrgTypeRepository>, IOrgTypeService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public OrgTypeService(IUnitOfWork unitOfWork, IOrgTypeRepository repository)
