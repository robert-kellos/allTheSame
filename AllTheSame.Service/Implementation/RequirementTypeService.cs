...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class RequirementTypeService : EntityService<RequirementType, IRequirementTypeRepository>, IRequirementTypeService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public RequirementTypeService(IUnitOfWork unitOfWork, IRequirementTypeRepository repository)
