...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class VendorTypeService : EntityService<VendorType, IVendorTypeRepository>, IVendorTypeService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public VendorTypeService(IUnitOfWork unitOfWork, IVendorTypeRepository repository)
