...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class VendorCredentialService : SyncEntityService<VendorCredential, IVendorCredentialRepository>, IVendorCredentialService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public VendorCredentialService(IUnitOfWork unitOfWork, IVendorCredentialRepository repository)
