...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class AlertService : SyncEntityService<Alert, IAlertRepository>, IAlertService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public AlertService(IUnitOfWork unitOfWork, IAlertRepository repository)
