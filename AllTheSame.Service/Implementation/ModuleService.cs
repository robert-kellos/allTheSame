...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class ModuleService : SyncEntityService<Module, IModuleRepository>, IModuleService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public ModuleService(IUnitOfWork unitOfWork, IModuleRepository repository)
