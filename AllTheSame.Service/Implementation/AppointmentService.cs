...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class AppointmentService : SyncEntityService<Appointment, IAppointmentRepository>, IAppointmentService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public AppointmentService(IUnitOfWork unitOfWork, IAppointmentRepository repository)
