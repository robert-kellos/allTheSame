...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class KioskService : SyncEntityService<Kiosk, IKioskRepository>, IKioskService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public KioskService(IUnitOfWork unitOfWork, IKioskRepository repository)
