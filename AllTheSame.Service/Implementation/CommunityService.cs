...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class CommunityService : SyncEntityService<Community, ICommunityRepository>, ICommunityService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public CommunityService(IUnitOfWork unitOfWork, ICommunityRepository repository)
