...
namespace AllTheSame.Service.Implementation
{
    ...
    /// </summary>
    public class FamilyMemberService : SyncEntityService<FamilyMember, IFamilyMemberRepository>, IFamilyMemberService
    {
        /// <summary>
        /// The _repository
        /// </summary>
        ...
        public FamilyMemberService(IUnitOfWork unitOfWork, IFamilyMemberRepository repository)
